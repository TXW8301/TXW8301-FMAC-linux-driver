...
enum hgic_cmd {
    ...
    HGIC_CMD_SET_EDCA_LIMIT_MAX     =  189, /* smac/fmac */
    HGIC_CMD_SET_EDCA_SLOT_TIME     =  190, /* smac/fmac */
    HGIC_CMD_SET_EDCA_LIMIT_MIN     =  191, /* smac/fmac */
    HGIC_CMD_SET_SIGNAL_THRESHOLD   =  192, /* fmac */
    HGIC_CMD_SET_ROAMING_BSSID      =  193, /* fmac */
    HGIC_CMD_GET_LINK_QUALITY       =  194, /* fmac */
